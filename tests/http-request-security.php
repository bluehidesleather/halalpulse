...
$credentialUrl = 'https://' . 'synthetic-user' . ':' . 'synthetic-pass' . '@www.nseindia.com/api';
$assert($rejects(static fn () => $policy->assertAllowedUrl($credentialUrl)), 'Credential-bearing URLs are rejected.');
